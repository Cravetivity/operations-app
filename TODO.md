...
- [ ] Scaffold backend (FastAPI, uv, SQLAlchemy async, Alembic, pytest, ruff)
- [ ] Scaffold frontend (Vite + React + TS + Tailwind + vite-plugin-pwa)
- [ ] Write docker-compose.yml (app + postgres) and complete .env.example
